...
streamlit.markdown(f'<h1 style="color:#FFFFFF;font-size:40px;">{"Snow View"}</h1>', unsafe_allow_html=True)
...
s=df.style.set_table_styles([
                            {
                               "selector":"thead",
                                "props":"font-weight:bold; color:#2c2f34; background-color:#86b6fd; border:1.3px black;"
                            },
                            {
                               "selector":"td",
